...
class TextStyles {
  ...
  static const p2Normal = TextStyle(fontSize: 14, fontWeight: FontWeight.normal,color: primaryColor);

  static const p3Bold = TextStyle(fontSize: 12, fontWeight: FontWeight.bold);
  static const p3Normal = TextStyle(fontSize: 12, fontWeight: FontWeight.normal,color: primaryColor);
}
